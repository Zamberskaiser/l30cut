...
rem   Script versao 24 (2026-09-04)
...
echo   Script versao 24 (2026-09-04)
echo ============================================
...
if errorlevel 1 (
  echo   [ERRO] Este pacote esta desatualizado ^(anterior a versao 24^).
  echo   Apague esta pasta e baixe novamente o arquivo L30-CUT-AI-source-v24.zip.
  goto :falhou
)
