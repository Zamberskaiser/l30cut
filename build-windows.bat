...
rem   Script versao 27 (2026-09-04b)
...
echo   Script versao 27 (2026-09-04b)
echo ============================================
...
if errorlevel 1 (
  echo   [ERRO] Este pacote esta desatualizado ^(anterior a versao 27^).
  echo   Apague esta pasta e baixe novamente o arquivo L30-CUT-AI-source-v27.zip.
  goto :falhou
)
